...
interface PythImplementationInterface extends ethers.utils.Interface {
  functions: {
...
export class PythImplementation extends BaseContract {
  ...
  interface: PythImplementationInterface;
