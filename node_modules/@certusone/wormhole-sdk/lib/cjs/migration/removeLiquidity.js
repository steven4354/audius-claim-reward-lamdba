...
function removeLiquidity(connection, payerAddress, program_id, from_mint, to_mint, liquidity_token_account, lp_share_token_account, amount) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ix = solana_1.ixFromRust(remove_liquidity(program_id, from_mint, to_mint, liquidity_token_account, lp_share_token_account, amount));
